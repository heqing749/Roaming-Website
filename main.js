...
const modelConfig = {
    'sunmao': {
        ...
        hotspots: [
            { pos: [-0.01, 0.01,0.01], title: "榫", text: "凸出来的负责插入与传力，将构件连接起来，并将受到的重量均匀分散" },
            { pos: [0.02, 0.01,0.01], title: "卯", text: "凹进去的负责容纳与锁紧，精准卡住榫头，限制构件各个方向的扭动与滑移" }
        ]
    },
    'dougong': {
        ...
        hotspots: [
            { pos: [0, 0.05,0.14], title: "斗", text: "最底层的方形木块，承托整个斗拱。" },
            //左边
            { pos: [-0.3, 0.25,0], title: "拱", text: "层层出挑，将屋檐重量传递到柱子上。" },
            //右边
            { pos: [0, 0.2, 0.35], title: "拱", text: "层层出挑，将屋檐重量传递到柱子上。" }
        ]
    },
    'tailiang': {
        ...
        hotspots: [
            { pos: [-1.8, 0.4, 0], title: "脊檩", text: "支撑屋顶重量的垂直构件。" },
            { pos: [-1.8, 0.15, 0.25], title: "立柱", text: "支撑屋顶重量的垂直构件。" },
            { pos: [0, 0.4, 0], title: "大梁", text: "架在柱头上，承受上部荷载。" },
            { pos: [0, 0.15,0.25], title: "大梁", text: "架在柱头上，承受上部荷载。" },
            { pos: [0, -0.05, 0.5], title: "大梁", text: "架在柱头上，承受上部荷载。" }
        ]
    }
};
